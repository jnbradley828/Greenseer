...
caffeinate -s -i -m fastchess \
    ...
    -concurrency 1 \
    -log engine=false \
    -pgnout file=benches/results/vs_main_middlegames/${TIMESTAMP}.pgn notation=uci nodes=true seldepth=true nps=true hashfull=true tbhits=true pv=true timeleft=true latency=true \
